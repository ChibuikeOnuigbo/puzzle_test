...
const Windows = (() => {
  ...
  function build(id, glass, opt = {}) {
    ...
    /* NOTE: no near trees here. Standing rule: trees outside windows exist
       ONLY in the bedroom's own garden view (bedroomGarden in rooms.js);
       every other window keeps treelines and hills, never a lone tree. */
