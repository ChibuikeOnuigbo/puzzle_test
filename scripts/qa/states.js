...
(async () => {
  ...
  const r = await page.evaluate(() => {
    ...
    const out = [];
    for (const room of ["porch","hallway","kitchen","study","basement","memory","landing","childroom","attic","diningroom","gallery","conservatory","bathroom","suite","washroom","steamroom","lavatory"]) {
