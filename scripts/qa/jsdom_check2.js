...
(async () => {
  ...
  const ROOMS_ALL = ["porch","hallway","kitchen","diningroom","conservatory","landing","study","childroom","attic","basement","memory","gallery","bathroom","suite","washroom","steamroom","lavatory","guestroom"];
